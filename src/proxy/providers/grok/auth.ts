/** CPA / token shape normalize + helpers for Grok Build OAuth. */

import { GROK_CLIENT_ID } from "./constants";
...
export type GrokNormalized = GrokTokens & { email: string };
...
export function normalizeGrokCpa(input: any): GrokNormalized {
  ...
  return {
    ...
    client_id: p.client_id || GROK_CLIENT_ID,
    expires_at: p.expires_at || p.expiresAt || undefined,
  };
}

/** @deprecated alias */
export const normalizeGrokCliCpa = normalizeGrokCpa;
/** @deprecated alias */
export type GrokCliTokens = GrokTokens;
/** @deprecated alias */
export type GrokCliNormalized = GrokNormalized;
